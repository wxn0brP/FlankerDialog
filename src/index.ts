...
export async function prompt(text: string, defaultValue = ""): Promise<string> {
...
export async function confirm(text: string, yesText: string = "OK", noText: string = "Cancel"): Promise<boolean> {
    return new Promise((resolve) => {
